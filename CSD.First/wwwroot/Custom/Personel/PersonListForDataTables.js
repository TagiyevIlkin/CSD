...
function deletePersonel(Fullname, id) {
    ...
    Swal.fire({
        title: Fullname +" "+'Silmək istədiyinizə əminsiniz?',
        type: 'warning',
        ...
        if (result.value) {
            $.get('/Personel/Delete/' + id).done(function (res) {
...
function deleteUser(UserName, id) {
    ...
    Swal.fire({
        title: UserName + 'Silmək istədiyinizə əminsiniz?',
        type: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
...
$(document).ready(function () {
    ...
    $("#dataTable").DataTable({
        ...
        "columns": [
            ...
            { "data": "PinCode", "name": "Fin kod", "autoWidth": true },
