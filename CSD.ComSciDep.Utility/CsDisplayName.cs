...
namespace CSD.ComSciDep.Utility
{
    public static class CsDisplayName
    {
        ...
        public const string SerialNumber = "Şəxsiyyə vəsiqəsinin seriya nömrəsi";
        public const string Email = "Elektron poçt ünvanı";
        public const string BirthPlace = "Doğum yeri";
        public const string Gencer = "Cinsi";
